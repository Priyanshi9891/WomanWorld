...
const WHATSAPP_NUMBER = "9839408887";
...
const branches = [
  {
    ...
    mapQuery: "Near Lanka Pragya Hospital, Lanka, Varanasi",
    phone: "+91 6386022738",
...
const initialReviews = [
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "I had an excellent experience at Radiant Glow Salon & Academy. The salon was hygienic, the products were high-quality, and the overall service was excellent. I left feeling rejuvenated.",
    service: "Salon Services",
  },
];
      ...
      <main className="pt-[76px] md:pt-[84px]">
        ...
        <section className="relative h-[340px] md:h-[400px] overflow-hidden">
          <img
            ...
            alt="Radiant Glow Salon & Academy"
              ...
              <div className="relative ww-fade-up">
                ...
                >
                  <img
                    ...
                    alt="Radiant Glow bridal styling"
